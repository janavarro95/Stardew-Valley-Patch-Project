...
$global:sourcefile = 'Stardew Valley.exe' # keep it in a pair of single quotes. Any single quote must be doubled (replace ' with '')
$global:targetfile = 'Stardew Valley.exe'
